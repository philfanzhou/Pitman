...
//    {
//        private readonly SinaDataReader dataReader = new SinaDataReader();

//        /// <summary>
//        /// 用于存储数据的缓存，最新数据与此缓存进行比较，从而判断数据是否已经更新
//        /// </summary>
//        private Dictionary<string, SinaRealTimeData> buffer = new Dictionary<string, SinaRealTimeData>();
...
//        {
//            List<SinaRealTimeData> newDataList = new List<SinaRealTimeData>();

//            List<SinaRealTimeData> datas = null;
//            try
//            {
//                // 避免网络出现异常
...
//        private void RaiseChangedData(List<SinaRealTimeData> newDataList)
//        {
...
//    {
//        public IEnumerable<SinaRealTimeData> DataList
//        {
//            get;
//            private set;
//        }

//        public DataChangedEventArgs(List<SinaRealTimeData> newDataList)
//        {
